 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status syncMsgs(::grpc::ClientContext* context, const ::ServerRpc::msg::syncMsgsReq& request, ::ServerRpc::msg::syncMsgsResp* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ServerRpc::msg::syncMsgsResp>> AsyncsyncMsgs(::grpc::ClientContext* context, const ::ServerRpc::msg::syncMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ServerRpc::msg::syncMsgsResp>>(AsyncsyncMsgsRaw(context, request, cq));
    }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status syncMsgs(::grpc::ClientContext* context, const ::ServerRpc::msg::syncMsgsReq& request, ::ServerRpc::msg::syncMsgsResp* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ServerRpc::msg::syncMsgsResp>> AsyncsyncMsgs(::grpc::ClientContext* context, const ::ServerRpc::msg::syncMsgsReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ServerRpc::msg::syncMsgsResp>>(AsyncsyncMsgsRaw(context, request, cq));
    }
  ...
  template <class BaseClass>
  class WithAsyncMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_syncMsgs() {
      ::grpc::Service::MarkMethodAsync(1);
    }
    ~WithAsyncMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ...
    void RequestsyncMsgs(::grpc::ServerContext* context, ::ServerRpc::msg::syncMsgsReq* request, ::grpc::ServerAsyncResponseWriter< ::ServerRpc::msg::syncMsgsResp>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithCallbackMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_syncMsgs() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::ServerRpc::msg::syncMsgsReq, ::ServerRpc::msg::syncMsgsResp>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::ServerRpc::msg::syncMsgsReq* request, ::ServerRpc::msg::syncMsgsResp* response) { return this->syncMsgs(context, request, response); }));}
    void SetMessageAllocatorFor_syncMsgs(
        ::grpc::MessageAllocator< ::ServerRpc::msg::syncMsgsReq, ::ServerRpc::msg::syncMsgsResp>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::ServerRpc::msg::syncMsgsReq, ::ServerRpc::msg::syncMsgsResp>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status syncMsgs(::grpc::ServerContext* /*context*/, const ::ServerRpc::msg::syncMsgsReq* /*request*/, ::ServerRpc::msg::syncMsgsResp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_syncMsgs() {
      ::grpc::Service::MarkMethodGeneric(1);
    }
    ~WithGenericMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status syncMsgs(::grpc::ServerContext* /*context*/, const ::ServerRpc::msg::syncMsgsReq* /*request*/, ::ServerRpc::msg::syncMsgsResp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_syncMsgs() {
      ::grpc::Service::MarkMethodRaw(1);
    }
    ~WithRawMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status syncMsgs(::grpc::ServerContext* /*context*/, const ::ServerRpc::msg::syncMsgsReq* /*request*/, ::ServerRpc::msg::syncMsgsResp* /*response*/) override {
    ...
    void RequestsyncMsgs(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_syncMsgs() {
      ::grpc::Service::MarkMethodRawCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->syncMsgs(context, request, response); }));
    }
    ~WithRawCallbackMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status syncMsgs(::grpc::ServerContext* /*context*/, const ::ServerRpc::msg::syncMsgsReq* /*request*/, ::ServerRpc::msg::syncMsgsResp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_syncMsgs : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_syncMsgs() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::ServerRpc::msg::syncMsgsReq, ::ServerRpc::msg::syncMsgsResp>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::ServerRpc::msg::syncMsgsReq, ::ServerRpc::msg::syncMsgsResp>* streamer) {
                       return this->StreamedsyncMsgs(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_syncMsgs() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status syncMsgs(::grpc::ServerContext* /*context*/, const ::ServerRpc::msg::syncMsgsReq* /*request*/, ::ServerRpc::msg::syncMsgsResp* /*response*/) override {
