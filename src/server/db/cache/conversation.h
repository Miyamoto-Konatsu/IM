...
public:
    ...
    std::vector<std::string> getConversationIdsKey(const std::vector<std::string>& users);
    std::vector<std::string> getConversationIdsHashKey(const std::vector<std::string>& users);
private:
